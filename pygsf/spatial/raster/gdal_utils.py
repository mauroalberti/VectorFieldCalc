...
class GDALParameters:
    ...
    def geo_equiv(self, other, tolerance=1.0e-6):
        ...
        if 2 * (self.get_topLeftX() - other.get_topLeftX()) / (
                self.get_topLeftX() + other.get_topLeftX()) > tolerance or \
                2 * (self.get_topLeftY() - other.get_topLeftY()) / (
                self.get_topLeftY() + other.get_topLeftY()) > tolerance or \
                2 * (abs(self.get_pixSizeEW()) - abs(other.get_pixSizeEW())) / (
                abs(self.get_pixSizeEW()) + abs(other.get_pixSizeEW())) > tolerance or \
                2 * (abs(self.get_pixSizeNS()) - abs(other.get_pixSizeNS())) / (
                abs(self.get_pixSizeNS()) + abs(other.get_pixSizeNS())) > tolerance or \
...
class Grid:
    ...
    def __init__(self, grid_params=None, grid_data=None):
        ...
        if grid_params is not None:
            ...
            pt_init = Point(grid_params.get_topLeftX(),
                            grid_params.get_topLeftY() - abs(grid_params.get_pixSizeNS()) * grid_params.get_rows())
            # define top-right corner as end point
            pt_end = Point(grid_params.get_topLeftX() + abs(grid_params.get_pixSizeEW()) * grid_params.get_cols(),
                           grid_params.get_topLeftY())
